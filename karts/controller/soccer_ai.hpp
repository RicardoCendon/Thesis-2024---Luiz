...
{
        //Kart Data
        unsigned int kartID; //getWolrdKartId
        float kartSteer; // getSteerPercent()
        float kartAccel;  //m_controls->getAccel()
        float kartSpeed; //getSpeed
        Vec3 kartPos; // getFrontXYZ()

        Vec3 kartVelocity; // getVelocity()
        Vec3 distanceToBall; //Ball Position - Kart Position
        
        //Ball Data
        Vec3 ballPos; //m_world-> getBallPosition()
        TargetType kartTarget;
